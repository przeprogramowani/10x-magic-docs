  ...
  return (
    <div className='space-y-8 p-6'>
      <h1 className='text-4xl font-bold mb-8 text-white'>
        Pierwsze kroki GitHub Actions: Automatyzacja przepływu pracy w
        repozytoriach
      </h1>
  ...
  build:
    ...
    steps:
      ...
      <Quiz
        ...
        question={{
          question:
            "Który plik konfiguracyjny jest wymagany do utworzenia GitHub Action?",
          options: [
        ...
        links={[
          {
            ...
            description:
              "Oficjalna dokumentacja z przykładami i najlepszymi praktykami",
          },
          {
