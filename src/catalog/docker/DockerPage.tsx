  ...
  return (
    <div className='container mx-auto px-4 py-8 space-y-8'>
      ...
      <TextBlock
        ...
        text="Docker is a platform that enables developers to build, package, and distribute applications as lightweight, portable containers. These containers include everything needed to run an application: code, runtime, system tools, libraries, and settings. This solves the age-old problem of 'it works on my machine' by ensuring consistent behavior across different environments."
      />

      <TextBlock
        header='Why Use Docker?'
        text='Docker addresses several critical challenges in modern software development:
...
CMD ["python", "app.py"]`}
      ...
      <TextBlock
        ...
        text='Understanding Docker requires familiarity with several fundamental concepts:

* **Images:** Read-only templates containing application code, libraries, dependencies, tools, and other files needed for an application to run
* **Containers:** Running instances of Docker images that can be created, started, stopped, moved, or deleted
* **Dockerfile:** A text document containing instructions to build a Docker image automatically
